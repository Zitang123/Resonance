...
Live token refresh, additional real users, logo appearance across Discord themes and other Discord contexts remain unverified. Last.fm history and unattended scheduling are still unconfigured; this connection does not populate the historical statistics archive. Earlier browser-suite evidence above describes the release when it was recorded.
